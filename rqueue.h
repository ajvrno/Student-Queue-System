...
class RQueue {
     ...
     ******************************************/
     ...
     Node* copy(Node* node);
     Node* merge(Node* heapNode, Node* newNode);
     Node* mergeLeftist(Node* heapNode, Node* newNode);
     Node* rebuildHeap(Node* node);
     void printQueueHelper(Node* node) const;
     int numStudentsHelper(Node* node) const;
